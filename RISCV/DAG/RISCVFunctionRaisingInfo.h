...
//===----------------------------------------------------------------------===//
//
// This file contains the declaration of RISCVFunctionRaisingInfo class for use
// by llvm-mctoll.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_TOOLS_LLVM_MCTOLL_RISCV32_DAG_FUNCTIONRAISERINGINFO_H
#define LLVM_TOOLS_LLVM_MCTOLL_RISCV32_DAG_FUNCTIONRAISERINGINFO_H
...
class RISCVFunctionRaisingInfo : public FunctionLoweringInfo {
public:
  ...
  /// Record the latest value of RISCV32::R0, if the current function has return
  /// value.
  ...
  void set(RISCV32ModuleRaiser &mr, Function &fn, MachineFunction &mf,
           SelectionDAG *DAG);
...
#endif // LLVM_TOOLS_LLVM_MCTOLL_RISCV32_DAG_FUNCTIONRAISERINGINFO_H
