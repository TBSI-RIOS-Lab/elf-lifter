...
void IREmitter::emitSpecialNode(SDNode *Node) {
  ...
  case EXT_ARMISD::BX_RET: {
    LLVM_DEBUG(dbgs()<<"detecterBranches bxret 1.0\n");
  ...
  case ISD::BRCOND: {
    LLVM_DEBUG(dbgs()<<"detecterBranches brcond 1.0\n");
  ...
  case ISD::BR: {
    // br label %xxx
    LLVM_DEBUG(dbgs()<<"detecterBranches br 1.0\n");
  ...
  case ISD::BRIND: {
    LLVM_DEBUG(dbgs()<<"detecterBranches brind 1.0\n");
  ...
  case ISD::BR_JT: {
    ...
    LLVM_DEBUG(dbgs()<<"detecterBranches brjt 1.0\n");
    if (jtList.size() > 0) {
      MachineBasicBlock *mbb = FuncInfo->MBBMap[CurBB];
  ...
  case ISD::ROTR: {
    LLVM_DEBUG(dbgs()<<"detecterBranches rotr 1.0\n");
  ...
  case ARMISD::RRX: {
    LLVM_DEBUG(dbgs()<<"detecterBranches rrx 1.0\n");
    Value *S0 = getIRValue(Node->getOperand(0));
    Type *Ty = getDefaultType();
  ...
  case ARMISD::CMN: {
    LLVM_DEBUG(dbgs()<<"detecterBranches cmn 1.0\n");
    Value *S0 = getIRValue(Node->getOperand(0));
    Value *S1 = getIRValue(Node->getOperand(1));
    Value *Inst;
    if (DAGInfo->NPMap[Node]->HasCPSR) {
  ...
  case ISD::CTLZ: {
    LLVM_DEBUG(dbgs()<<"detecterBranches ctlz 1.0\n");
    Value *S0 = getIRValue(Node->getOperand(0));
  ...
  case EXT_ARMISD::MLA: {
    LLVM_DEBUG(dbgs()<<"detecterBranches mla 1.0\n");
    Value *S0 = getIRValue(Node->getOperand(0));
    Value *S1 = getIRValue(Node->getOperand(1));
  ...
  case EXT_ARMISD::TST: {
    LLVM_DEBUG(dbgs()<<"detecterBranches tst 1.0\n");
    Value *S0 = getIRValue(Node->getOperand(0));
    Value *S1 = getIRValue(Node->getOperand(1));
  ...
  case EXT_ARMISD::SBC: {
    LLVM_DEBUG(dbgs()<<"detecterBranches sbc 1.0\n");
  ...
  case EXT_ARMISD::TEQ: {
    LLVM_DEBUG(dbgs()<<"detecterBranches teq 1.0\n");
    Value *S0 = getIRValue(Node->getOperand(0));
    Value *S1 = getIRValue(Node->getOperand(1));
  ...
  case EXT_ARMISD::MSR: {
    LLVM_DEBUG(dbgs()<<"detecterBranches msr 1.0\n");
  ...
  case EXT_ARMISD::MRS: {
    LLVM_DEBUG(dbgs()<<"detecterBranches mrs 1.0\n");
  ...
  case ISD::ADDC: {
    LLVM_DEBUG(dbgs()<<"detecterBranches addc 1.0\n");
    Value *S0 = getIRValue(Node->getOperand(0));
    Value *S1 = getIRValue(Node->getOperand(1));
    Type *OperandTy = getDefaultType();
  ...
  case EXT_ARMISD::RSC: {
    LLVM_DEBUG(dbgs()<<"detecterBranches rsc 1.0\n");
    Value *S0 = getIRValue(Node->getOperand(0));
    Value *S1 = getIRValue(Node->getOperand(1));
  ...
  case EXT_ARMISD::UXTB: {
    LLVM_DEBUG(dbgs()<<"detecterBranches uxtb 1.0\n");
    Value *S1 = getIRValue(Node->getOperand(1));
  ...
  case EXT_ARMISD::RSB: {
    LLVM_DEBUG(dbgs()<<"detecterBranches rsb 1.0\n");
    Value *S0 = getIRValue(Node->getOperand(0));
    Value *S1 = getIRValue(Node->getOperand(1));
